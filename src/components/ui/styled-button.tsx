...
export const StyledButton: React.FC<StyledButtonProps> = ({ 
  ...
  const baseStyles = {
    primary: cn(
      ...
      "after:absolute after:inset-0 after:rounded-[127.434px] after:bg-[length:250%_250%]",
      "after:bg-gradient-to-tl after:from-[#00D0C6] after:via-[#0FA0CE]/95 after:to-[#0EA5E9]",
