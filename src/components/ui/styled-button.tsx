...
export const StyledButton: React.FC<StyledButtonProps> = ({ 
  ...
  const baseStyles = {
    primary: "w-[207px] h-[38px] py-5 flex items-center justify-center bg-[#173C3F] border border-[#00D0C6] rounded-[127.434px] text-white font-bold text-[15.5071px] leading-[120%] tracking-[-0.03em] capitalize transition-all duration-200 hover:bg-[#00D0C6] hover:border-[#00D0C6] hover:scale-[1.02] active:bg-[#00b8af] active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100",
