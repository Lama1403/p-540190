...
export const NetworkSelector: React.FC<NetworkSelectorProps> = ({ network }) => {
  return (
    <div className="flex flex-row justify-between items-center p-[17px] gap-[8px] w-full h-[64px] min-h-[48px] bg-[#1E1D1D]/10 backdrop-blur-lg shadow-2xl rounded-[15px]">
