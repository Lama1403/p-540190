...
export const WalletInfo: React.FC<WalletInfoProps> = ({ address, balance }) => {
  return (
    <div className="flex flex-row justify-between items-center p-[17px] gap-[8px] w-full h-[64px] min-h-[48px] bg-black/10 backdrop-blur-lg border border-white/20 shadow-2xl rounded-[15px]">
