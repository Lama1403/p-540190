...
const Index = () => {
  ...
  return (
    <Background>
      ...
      >
        <div className={`w-full max-w-md h-full flex items-center transition-all duration-500 ${isSwapCompleted ? 'opacity-50 scale-95 pointer-events-none' : 'opacity-100 scale-100'}`}>
